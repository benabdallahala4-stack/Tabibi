...
const L = {
  fr: {
    ...
    shareText: "Activez le partage puis donnez ce code à votre praticien (au cabinet, en visio ou par message). Il le saisit dans son espace Seha Pro pour consulter votre dossier. Désactivez ou changez le code à tout moment pour couper l'accès.",
  ...
  ar: {
    ...
    shareText: "فعّل المشاركة ثم أعطِ هذا الرمز لطبيبك (في العيادة، عبر الفيديو أو برسالة). يُدخله الطبيب في فضاء صحة برو للاطلاع على ملفك. عطّل المشاركة أو غيّر الرمز في أي وقت لقطع الوصول.",
